...
collocations.add_pair_of_words("foo", "moo")
collocations.add_pair_of_words("foo", "moo")
collocations.add_pair_of_words("fo", "moo")
collocations.add_pair_of_words("foo", "mooo")
collocations.add_pair_of_words("foo", "moooo")

collocations.print_structure
